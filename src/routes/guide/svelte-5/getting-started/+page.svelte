...
<h1>Getting Started - Svelte Ionicons v2</h1>

<div class="my-8 flex gap-2">
  <a href="https://github.com/sponsors/shinokada" target="_blank" rel="nofollow" aria-label="Sponsor me"
    ><img
      src="https://img.shields.io/static/v1?label=Sponsor&message=%E2%9D%A4&logo=GitHub&color=%23fe8e86"
      alt="sponsor"
    /></a
  >
  <a href="https://www.npmjs.com/package/svelte-ionicons" rel="nofollow" target="_blank" aria-label="npm svelte-ionicons"
    ><img src="https://img.shields.io/npm/v/svelte-ionicons/next" alt="npm" /></a
  >
...
<p>All icons have "...restProps" and you can pass other attibutes as well.</p>

<HighlightCompo codeLang="ts" code={modules['./md/passing-down-other-attributes.md'] as string} />

<H2>Import all</H2>

<p>Use <Code>import * as Icon from 'svelte-ionicons'</Code>.</p>
