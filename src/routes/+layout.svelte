...
<div class="max-h-screen overflow-auto relative w-full" id="svelte">
  <header
    class="sticky top-0 z-40 flex-none w-full mx-auto bg-white border-b border-gray-200 dark:border-gray-600 dark:bg-purple-950"
  >
    <Navbar color="default" fluid let:hidden let:toggle class="dark:bg-purple-950 ">
      <NavBrand href="/">
        <span
  ...
  <Footer footerType="logo" class="dark:bg-purple-950">
