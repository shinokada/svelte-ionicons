<script>
  ...
  export let ariaLabel = 'VolumeMediumSharp';
</script>
...
<svg
  ...
  on:mouseover
  on:mouseout
  ><polygon points="157.65 176.1 64 176.1 64 335.9 157.65 335.9 288 440 288 72 157.65 176.1" /><path
...
@prop export let ariaLabel = 'VolumeMediumSharp';
-->
