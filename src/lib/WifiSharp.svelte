<script>
  ...
  export let ariaLabel = 'WifiSharp';
</script>
...
<svg
  ...
  ><path
    ...
    style="fill:none;stroke:{color};stroke-linecap:square;stroke-linejoin:round;stroke-width:42px"
  /><path
...
@prop export let ariaLabel = 'WifiSharp';
-->
