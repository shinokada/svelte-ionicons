<script>
  ...
  export let ariaLabel = 'EyeOffOutline';
</script>
...
<svg
  ...
  /><path d="M165.78,233.66a2,2,0,0,0-3.38,1,96,96,0,0,0,115,115,2,2,0,0,0,1-3.38Z" /></svg
>
...
@prop export let ariaLabel = 'EyeOffOutline';
-->
