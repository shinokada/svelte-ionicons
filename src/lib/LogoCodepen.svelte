<script>
  ...
  export let ariaLabel = 'LogoCodepen';
</script>
...
<svg
  ...
  /><polygon points="141 237.12 141 276.73 170.62 256.89 141 237.12" /><path
  ...
  /><polygon points="370 276.68 370 237.06 340.41 256.93 370 276.68" /></svg
>
...
@prop export let ariaLabel = 'LogoCodepen';
-->
