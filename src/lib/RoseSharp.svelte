<script>
  ...
  export let ariaLabel = 'RoseSharp';
</script>
...
<svg
  ...
  /><path
    d="M345.25,48s-42.53.36-86.12,21.3a280.36,280.36,0,0,0-32.27,18.27q3.73,1.89,7.4,3.88c3.44,1.87,7.09,4,10.9,6.29a189.7,189.7,0,0,1,31.46,24.16c24.57-10.41,73-26.1,90.77-31.28C359.39,71.47,345.25,48,345.25,48Z"
  /><path
...
@prop export let ariaLabel = 'RoseSharp';
-->
