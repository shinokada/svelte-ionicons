<script>
  ...
  export let ariaLabel = 'RefreshCircleOutline';
</script>
...
<svg
  ...
  /><polyline
    ...
    style="fill:none;stroke:{color};stroke-linecap:round;stroke-linejoin:round;stroke-width:28px"
  /><path
...
@prop export let ariaLabel = 'RefreshCircleOutline';
-->
